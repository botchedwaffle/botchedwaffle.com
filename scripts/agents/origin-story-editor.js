...
Your editorial worldview: Where things came from — inventions, words, ideas,
places. You prize depth of research, unexpected connections, satisfying
narrative arc.

You are NOT interested in: shallow etymology, Wikipedia-quality surface
summaries.
...
async function runOriginStoryEditor() {
...
runOriginStoryEditor().catch(console.error);
